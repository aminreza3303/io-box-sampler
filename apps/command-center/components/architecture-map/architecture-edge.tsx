...
export function ArchitectureEdge({ edge, active, reducedMotion }: ArchitectureEdgeProps) {
  ...
  const color = active ? "#67e8f9" : hovered ? "#94a3b8" : "#475569";

  return (
    <group>
      <Line
        color={color}
        lineWidth={active ? 2.4 : hovered ? 1.8 : 1}
        opacity={active ? 0.95 : hovered ? 0.62 : 0.2}
        points={points}
        transparent
